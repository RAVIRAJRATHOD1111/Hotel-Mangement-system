...
<body class="bg-light">
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-lg-3  col-mb-12  mb-lg-0 mb-4 ps-4">
        <nav class="navbar navbar-expand-lg navbar-light bg-white rounded shadow">
          <div class="container-fluid flex-lg-column align-items-stretch">
            <h4 class="mt-2">FILTES</h4>
  ...
  <script>
    ...
    function fetch_rooms() {
      ...
      xhr.onprogress = function() {
        rooms_data.innerHTML = "<div class='spinner-border text-info mb-3 d-none' id='info_loader' role='status'><span class='visually-hidden'>Loading...</span></div>";
      }
