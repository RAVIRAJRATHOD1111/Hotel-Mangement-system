    ...
    <div class="row">
      ...
      while ($data = mysqli_fetch_assoc($result)) {
        ...
        if ($data['booking_status'] == 'booked') {
          ...
          if ($data['arrival'] == 1) {
            $btn = "<a  href='generate_pdf.php?gen_pdf&id=$data[booking_id]' class='btn btn-dark btn-sm   shadow-none'>Dowload PDF </a>
                ";
        ...
        <form id="review-form">
          ...
          <div class="modal-body">
            ...
            <div class="mb-4">
              ...
              <textarea type="text" name="review" rows="3" required
  ...
  <script>
    function cancel_booking(id) {
      if (confirm('Are you sure to cancel booking?')) {
        ...
        // Move the xhr.send inside the confirm block
    ...
    function review_room(bid, rid) {
      review_form['booking_id'].value = bid;
      review_form['room_id'].value = rid;
    }

    review_form.addEventListener('submit', function(e) {
      e.preventDefault();
      let data = new FormData();
      data.append('review_form', '0');
