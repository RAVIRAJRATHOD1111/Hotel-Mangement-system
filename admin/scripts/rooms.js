let add_room_form = document.getElementById('add_room_form');
        ...
        function add_room() {
            ...
            data.append('num_room', add_room_form.elements['num_room'].value);
        ...
        function edit_details(id) {
            ...
            xhr.onload = function() {
                ...
                edit_room_form.elements['num_room'].value = data.roomdata.num_room;
        ...
        function submit_edit_room() {
            ...
            data.append('num_room', edit_room_form.elements['num_room'].value);
        ...
        function add_image() {
            ...
            xhr.onload = function() {
                if (this.responseText == 'inv_img') {
                    ...
                    alert('error', 'image uplod failed.server Down!', 'image-alert');
                } else {
