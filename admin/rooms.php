                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Num. of Rooms</label>
                                <input type="number" min="1" name="num_room" class="form-control shadow-none" required>
                            </div>
                            <div class="col-md-6 mb-3">
