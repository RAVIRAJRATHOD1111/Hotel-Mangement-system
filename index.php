...
<body class="bg-light">
  ...
  <div class="container">
    <div class="row">
      ...
      while ($room_data = mysqli_fetch_assoc($room_res)) {
        ...
        //if site is shutdown hide book button
        $book_btn = "";
        if(!$settings_r['shutdown'] ){   
          ...
          if(isset($_SESSION['login']) && $_SESSION['login'] == true){
           ...
           $book_btn = "<button onclick='checkLoginToBook($login,$room_data[id])' class='btn btn-sm text-white custom-bg shadow'>Book now</button>";
                ...
                <div class="card border-0 shadow" style="max-width: 350px; margin: auto;">
                  ...
                  <div class="card-body ">
                    ...
                    <div class="d-flex justify-content-evenly mb-2 ">
                      $book_btn
                      <a href="room_details.php?id=$room_data[id]" class="btn btn-sm  btn-outline-dark shadow">More details</a>
                    </div>
  ...
  <div class="container">
    <div class="row justify-content-evenly px-lg-0 px-mb-0 px-5">
      ...
      <div class="col-lg-12 text-center mt-5">
        <a href="facilites.php" class=" btn btn-sm btn-outline-dark rounded-0 fw-bold shadow-none"> know more Facilites>>></a>
      </div>
    </div>
  </div>

  <!-- Rating & Reviews -->
  <h2 class="mt-5 pt-4 mb-4 text-center fw-bold h-font ">Rating & Reviews</h2>
      ...
      <div class="col-lg-4 col-md-4">
        ...
        data;
          ...
          <a href="<?php echo $contact_r['fb'] ?>" class="d-inline-block mb-3 ">
            <span class="badge bg-light text-dark fs-6 p-2"> <i class="bi bi-facebook"></i> Facebook
            </span></a>
          <br>
          <a href="<?php echo $contact_r['insta'] ?>" class="d-inline-block  ">
            <span class="badge bg-light text-dark fs-6 p-2"> <i class="bi bi-instagram"></i> Instagram
            </span></a>
        </div>
      </div>
    </div>
